...
it was created in the Visual Studio 2022 Enterprise Previewto toolset v143.
...
classes referenced in the app's XAML pages. Is based on RotoDraw3d/Hot3dxSymmetry3D
...
- Make sure to install the "C++ (v142) and (v143) for Universal Windows Platform tools" 
